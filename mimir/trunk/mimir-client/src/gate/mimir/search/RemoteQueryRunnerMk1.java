...
public class RemoteQueryRunnerMk1 implements QueryRunnerMk1 {
  /**
  ...
  private Logger logger = Logger.getLogger(RemoteQueryRunnerMk1.class);
  ...
  /**
   * Constructs a new RemoteQueryRunnerMk1.
   * 
   * @param remoteUrl
   ...
   * communication.
   */
  public RemoteQueryRunnerMk1(String remoteUrl, String queryString,
